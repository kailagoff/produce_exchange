...
describe('Event') do
  ...
  it("capitalizes the event title") do
    event1 = Event.create({:title => "jarring workshop", :date => "2018-04-22", :description => "a".*(149), :quadrant => "Northwest"})
    expect(event1.title()).to(eq("Jarring Workshop"))
  end
